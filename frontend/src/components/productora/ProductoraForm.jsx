...
export default function ProductoraForm({ initialData, onSubmit, onCancel, saving }) {
    ...
    return (
        <form onSubmit={(e) => { e.preventDefault(); onSubmit(form); }}>
            <div className="form-group">
                ...
                <input className="form-control-custom" value={form.nombre} onChange={(e) => set('nombre', e.target.value)} required minLength={2} placeholder="Ej: Warner Bros, Netflix..." />
            </div>
            <div className="form-group">
